// Contenu de gui/panels/ToolbarPanel.java
package gui.panels;
...
public class ToolbarPanel extends JToolBar {
    ...
    public ToolbarPanel(Moto6809 frame) {
        setFloatable(false);
        ...
        simGroup.add(addButton(loadIcon("reprendre.png"), "Reprendre (F8)", frame::resumeSimulation));
        ...
        toolsGroup.add(addButton(loadIcon("memory.png"), "Mémoire", frame::showRamMemory));
        ...
        helpGroup.add(addButton(loadIcon("help.png"), "Aide", () -> {}));
        add(helpGroup);
    }
