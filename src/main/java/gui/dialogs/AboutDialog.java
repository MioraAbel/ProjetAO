...
public class AboutDialog extends BaseDialog {
    ...
    protected void initContent() {
        ...
        JLabel author = ComponentFactory.createLabel("Développé par : Votre Nom / Groupe");
        contentPanel.add(author, gbc);

        JLabel year = ComponentFactory.createLabel("Année : 2023-2024");
        contentPanel.add(year, gbc);

        JLabel description = ComponentFactory.createLabel("<html><center>Un simulateur de microprocesseur Motorola 6809<br>avec environnement d'assemblage et de débogage.</center></html>");
